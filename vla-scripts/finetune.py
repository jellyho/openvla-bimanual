...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    with tqdm.tqdm(total=cfg.max_steps, leave=False) as progress:
        ...
        for batch_idx, batch in enumerate(dataloader):
            ...
            # Compute Accuracy
            # print('action labels', action_gt.shape, action_preds.shape)
            # print('action labels', action_gt, action_preds)
            correct_preds = (action_preds == action_gt) & mask
            action_accuracy = correct_preds.sum().float() / mask.sum().float()

            # Compute L1 Loss on Predicted (Continuous) Actions
            # print(action_preds[mask].shape)
            ...
            # print('cont', continuous_actions_pred.shape, continuous_actions_gt.shape)
            # print(continuous_actions_pred, continuous_actions_gt)
